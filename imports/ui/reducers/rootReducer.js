...
const initState = {
    ...
    "courses": {
        "core": [
            { "type": "core", "dept": "CPSC", "num": 110, "grade": 89, "id": shortid.generate() },
            { "type": "core", "dept": "CPSC", "num": 210, "grade": 89, "id": shortid.generate() },
            { "type": "core", "dept": "ENGL", "num": 110, "grade": 89, "id": shortid.generate() },
            { "type": "core", "dept": "MATH", "num": 200, "grade": 89, "id": shortid.generate() }
        ],
        "bridging": [
            { "type": "bridging", "dept": "STAT", "num": 302, "grade": 89, "id": shortid.generate() },
            { "type": "bridging", "dept": "STAT", "num": 305, "grade": 89, "id": shortid.generate() },
            { "type": "bridging", "dept": "STAT", "num": 306, "grade": 89, "id": shortid.generate() }
        ],
        "exemptions": [
            { "type": "exemptions", "dept": "ENGL", "num": 110, "grade": 89, "id": shortid.generate() },
            { "type": "exemptions", "dept": "STAT", "num": 200, "grade": 89, "id": shortid.generate() },
            { "type": "exemptions", "dept": "MATH", "num": 108, "grade": 89, "id": shortid.generate() }
        ],
        "replacements": [
            { "type": "replacements", "dept": "MATH", "num": 221, "grade": 89, "id": shortid.generate() },
            { "type": "replacements", "dept": "MATH", "num": 200, "grade": 89, "id": shortid.generate() },
            { "type": "replacements", "dept": "DSCI", "num": 100, "grade": 89, "id": shortid.generate() }
        ]
    }
}
